...
func TestInvalidCheckVBoxManageVersion(t *testing.T) {
	var tests = []struct {
		...
		{"4.1.1", `We support Virtualbox starting with version 5. Your VirtualBox install is 4.1. Please upgrade at https://www.virtualbox.org`},
		{"4.2.36-104064", `We support Virtualbox starting with version 5. Your VirtualBox install is 4.2. Please upgrade at https://www.virtualbox.org`},
		{"X.Y", `Failed to parse Virtualbox version: "X.Y"`},
		{"", `Failed to parse Virtualbox version: ""`},
		{" 7.0", `Failed to parse Virtualbox version: " 7.0"`},
		{"WARNING: A warning containing version string 4.1.1 somewhere.",
			`Failed to parse Virtualbox version: "WARNING: A warning containing version string 4.1.1 somewhere."`},
		{"WARNING: Environment variable LOGNAME or USER does not correspond to effective user id.\n4.0.18r162988",
			`We support Virtualbox starting with version 5. Your VirtualBox install is 4.0. Please upgrade at https://www.virtualbox.org`},
	}
